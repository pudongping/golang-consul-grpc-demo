...
func (x *HelloResponse) GetCode() uint32 {
	if x != nil {
		return x.Code
	}
	return 0
...
var file_hello_world_proto_rawDesc = []byte{
	...
	0x01, 0x28, 0x09, 0x52, 0x04, 0x64, 0x61, 0x74, 0x61, 0x32, 0x38, 0x0a, 0x03, 0x53, 0x61, 0x79,
	0x12, 0x31, 0x0a, 0x02, 0x48, 0x69, 0x12, 0x13, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x2e, 0x48,
...
var file_hello_world_proto_depIdxs = []int32{
	0, // 0: proto.Say.Hi:input_type -> proto.HelloRequest
	1, // 1: proto.Say.Hi:output_type -> proto.HelloResponse
...
type SayClient interface {
	Hi(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error)
}
...
func (c *sayClient) Hi(ctx context.Context, in *HelloRequest, opts ...grpc.CallOption) (*HelloResponse, error) {
	out := new(HelloResponse)
	err := c.cc.Invoke(ctx, "/proto.Say/Hi", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type SayServer interface {
	Hi(context.Context, *HelloRequest) (*HelloResponse, error)
}
...
func (*UnimplementedSayServer) Hi(context.Context, *HelloRequest) (*HelloResponse, error) {
...
func _Say_Hi_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(HelloRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(SayServer).Hi(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/proto.Say/Hi",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(SayServer).Hi(ctx, req.(*HelloRequest))
	}
